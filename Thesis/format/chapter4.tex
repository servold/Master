...
We develop an algorithm for the clustering problem given in (\ref{StateEq4}) with Euclidean distance-like function. We can not apply the general methodology of \Cref{State_PALM_Theory} directly due to the lack of smooth part in the obtained model. Therefore, we approximate the $H$ part of the objective function. \textbf{bla bla bla}
