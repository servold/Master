...
\end{aligned}
\end{equation*}
where the third inequality follows from \Cref{StateEq11}, and $\overline{\alpha}(t) = \max\limits_{1 \leq i \leq m} \alpha_i(t)$. Define \\$\rho_2 = \max_{t\in \mathbb{N}} m \left( 4M + \overline{\alpha}(t) \right)$ and the result follows.
\end{proof}
...
\begin{proof}
For any $w_l \in \mathbb{R}^m$ and $x^l \in \mathbb{R}^n$ we have
\begin{equation*}
