...
%    \end{frame}
	...
	\begin{frame}{Global Convergence of $\varepsilon$-KPALM}
		...
		\pause
		\begin{proposition}[Sufficient decrease property]
		Suppose that \Cref{AssumptionsB} and let $\left\lbrace z(t) \right\rbrace_{t \in \mathbb{N}}$ be the sequence generated by $\varepsilon$-KPALM. Then, there exists $\rho_1 > 0$ such that 
		\begin{equation*}
		...
		\pause
		\begin{theorem}
		Suppose that \Cref{AssumptionsB} holds true and let $\left\lbrace z(t) \right\rbrace_{t \in \mathbb{N}}$ be the sequence generated by $\varepsilon$-KPALM. Then, the sequence $\left\lbrace z(t) \right\rbrace_{t \in \nn}$ converges to a critical point of $\sigma_{\varepsilon}$.
		\end{theorem}
	\end{frame}	
