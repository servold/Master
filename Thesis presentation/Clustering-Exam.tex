...
\begin{frame}{The Clustering Problem}
	...
	\begin{frame}{Convergence Methodology: Definitions}
        ...
        \begin{assumption} \label{AssumptionsA}
            \begin{itemize}
                \item[$\rm{(i)}$] $f : \rr^{n} \rightarrow \overline{\rr}$ and $g : \rr^{m} 
                	\rightarrow \overline{\rr}$ are proper and lsc functions. %\footnote{ We 
                	%denote $\overline{\rr} = \left(-\infty , +\infty\right]$ and write lsc 
